...
/**
 * <p>Clase Java para limpiaUsuarioGrupoProceso complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="limpiaUsuarioGrupoProceso">
 *   &lt;complexContent>
...
@XmlType(name = "limpiaUsuarioGrupoProceso", propOrder = {
    "idGrupo",
    "idProceso"
})
public class LimpiaUsuarioGrupoProceso {
