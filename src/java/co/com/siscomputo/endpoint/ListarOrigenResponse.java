...
/**
 * <p>Clase Java para ListarOrigenResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ListarOrigenResponse">
 *   &lt;complexContent>
...
@XmlType(name = "ListarOrigenResponse", propOrder = {
    "_return"
})
public class ListarOrigenResponse {
