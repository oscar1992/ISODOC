...
/**
 * <p>Clase Java para listaProveedorResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listaProveedorResponse">
 *   &lt;complexContent>
...
@XmlType(name = "listaProveedorResponse", propOrder = {
    "_return"
})
public class ListaProveedorResponse {
