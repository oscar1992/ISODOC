...
/**
 * <p>Clase Java para rutaPorTipoResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="rutaPorTipoResponse">
 *   &lt;complexContent>
...
@XmlType(name = "rutaPorTipoResponse", propOrder = {
    "_return"
})
public class RutaPorTipoResponse {
