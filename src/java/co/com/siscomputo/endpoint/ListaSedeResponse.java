...
/**
 * <p>Clase Java para listaSedeResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listaSedeResponse">
 *   &lt;complexContent>
...
@XmlType(name = "listaSedeResponse", propOrder = {
    "_return"
})
public class ListaSedeResponse {
