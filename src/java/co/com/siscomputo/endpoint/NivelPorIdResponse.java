...
/**
 * <p>Clase Java para nivelPorIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="nivelPorIdResponse">
 *   &lt;complexContent>
...
@XmlType(name = "nivelPorIdResponse", propOrder = {
    "_return"
})
public class NivelPorIdResponse {
