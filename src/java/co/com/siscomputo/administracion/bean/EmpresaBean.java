...
public class EmpresaBean {
    ...
    public void ingresarEmpresa() {
        try {
            ...
            if (empresaEntity != null) {
                MensajesJSF.muestraMensajes( "Empresa Ingresada Correctamente: " + empresaEntity.getNombreEmpresa(), "Mensaje");
                adicionarEmpresaLista(empresaEntity);
            } else {
                MensajesJSF.muestraMensajes( "Empresa Ingresada Incorrectamente: " + empresaEntity.getNombreEmpresa(), "Error");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actualizarEmpresa() {
        ...
        if ("Ok".equalsIgnoreCase(valida)) {
            ...
            MensajesJSF.muestraMensajes( "Empresa Actualizada Correctamente: " + empresaObjeto.getNombreEmpresa(), "Mensaje");
        } else if ("Error".equalsIgnoreCase(valida)) {
            MensajesJSF.muestraMensajes( "Empresa Actualizada Incorrectamente: " + empresaObjeto.getNombreEmpresa(), "Error");
        }
        nuevaEmpresa();
    ...
    public void eliminarEmpresa() {
        ...
        MensajesJSF.muestraMensajes( "Empresa Eliminada Correctamente: " + empresaObjeto.getNombreEmpresa(), "Mensaje");
    }
